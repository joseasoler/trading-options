...
public static class StockScaling
{
	...
	/// <summary>
	/// Calculate wealth scaling for a specific set of conditions.
	/// </summary>
	/// <param name="category">Trader category of the owner of the item.</param>
	/// <param name="def">Item being generated.</param>
	/// <param name="wealth">Colony wealth.</param>
	/// <returns>Wealth scaling amount.</returns>
